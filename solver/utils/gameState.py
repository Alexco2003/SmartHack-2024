...
class GameState:
    ...
    def add_connection_to_queue(self, connection, days, capacity):
        ...
        self.graph.connections_dict[(Graph.id_hashmap[connection['from_id']], Graph.id_hashmap[connection['to_id']])][0]['current_capacity'] = capacity
...
# print(astar(game.graph.id_hashmap['beb6ba68-6d89-48e0-a6aa-1ee978bafa27'], game.graph.id_hashmap['8a50c288-5063-433f-8da6-64f7a0b4f361'], 1000, lambda x,y: 1, game))
# print(Graph.connections_dict[(0,17)])